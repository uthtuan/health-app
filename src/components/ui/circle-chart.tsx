    ...
    <div className="relative w-full h-full flex items-center justify-center"
      ...
      <div className="absolute w-full h-full flex flex-col items-center justify-center text-white">
        <div className="flex flex-row items-end justify-center w-full">
          ...
          <span className="text-3xl font-bold" style={{ textShadow: '0 0 8px #fb923c' }}>{percent}<span className="text-xl font-normal" style={{ textShadow: '0 0 8px #fb923c' }}>%</span></span>
        </div>
      </div>
    </div >
  );
